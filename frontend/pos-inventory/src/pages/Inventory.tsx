              ...
              {filteredProducts.map((product) => {
                ...
                return (
                  <tr key={product.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm font-semibold text-green-700">₦{product.sell_price.toLocaleString()}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                  ...
                  <div key={product.id} className="p-4 hover:bg-gray-50 transition-colors">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm mb-4">
                      ...
                      <div className="bg-green-50 p-3 rounded-lg">
                        ...
                        <div className="font-medium text-green-700">₦{product.sell_price.toLocaleString()}</div>
                      </div>
                ...
                <div key={product.id} className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 hover:shadow-md transition-shadow">
                  ...
                  <div className="space-y-2 text-sm mb-4">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium text-green-700">₦{product.sell_price.toLocaleString()}</span>
                    </div>
                    <div className="flex justify-between">
